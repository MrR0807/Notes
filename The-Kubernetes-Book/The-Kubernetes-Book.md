...
- [2: Kubernetes principles of operation](#2-kubernetes-principles-of-operation)
  * [Masters (control plane)](#masters-control-plane)
  * [Nodes](#nodes)
  * [Kubernetes DNS](#kubernetes-dns)
  * [Pods](#pods)
- [4: Working with Pods](#4-working-with-pods)
  * [Pods and shared networking](#pods-and-shared-networking)
  * [Pods and cgroups](#pods-and-cgroups)
  * [Pod manifest files](#pod-manifest-files)
  * [Deploying Pods from a manifest file](#deploying-pods-from-a-manifest-file)
  * [Introspecting running Pods](#introspecting-running-pods)
  * [kubectl describe](#kubectl-describe)
  * [kubectl exec: running commands in Pods](#kubectl-exec-running-commands-in-pods)
  * [kubectl logs](#kubectl-logs)
- [5: Kubernetes Deployments](#5-kubernetes-deployments)
  * [Deployment theory](#deployment-theory)
  * [Rolling updates with Deployments](#rolling-updates-with-deployments)
  * [Rollbacks](#rollbacks)
  * [How to create a Deployment](#how-to-create-a-deployment)
  * [Inspecting Deployments](#inspecting-deployments)
  * [Accessing the app](#accessing-the-app)
  * [Performing a rolling update](#performing-a-rolling-update)
  * [How to perform a rollback](#how-to-perform-a-rollback)
- [6: Kubernetes Services](#6-kubernetes-services)
  * [Setting the scene](#setting-the-scene)
  * [Theory](#theory)
  * [Labels and loose coupling](#labels-and-loose-coupling)
  * [Services and Endpoint objects](#services-and-endpoint-objects)
  * [Accessing Services from inside the cluster](#accessing-services-from-inside-the-cluster)
  * [Accessing Services from outside the cluster](#accessing-services-from-outside-the-cluster)
  * [Service discovery](#service-discovery)
  * [Hands-on with Services](#handson-with-services)
    + [The imperative way](#the-imperative-way)
    + [The declarative way](#the-declarative-way)
  * [Common Service types](#common-service-types)
  * [Endpoints objects](#endpoints-objects)
- [7: Service discovery](#7-service-discovery)
  * [Service registration](#service-registration)
  * [Summarising service registration](#summarising-service-registration)
  * [Service discovery](#service-discovery)
  * [Converting names to IP addresses using the cluster DNS](#converting-names-to-ip-addresses-using-the-cluster-dns)
  * [Summarising service discovery](#summarising-service-discovery)
  * [Service discovery and Namespaces](#service-discovery-and-namespaces)
...
- [8: Kubernetes storage](#8-kubernetes-storage)
  ...
  * [The Kubernetes persistent volume subsystem](#the-kubernetes-persistent-volume-subsystem)
  * [Storage Classes and Dynamic Provisioning](#storage-classes-and-dynamic-provisioning)
    + [A StorageClass YAML](#a-storageclass-yaml)
    + [Implementing StorageClasses](#implementing-storageclasses)
  * [Demo](#demo)
    + [Create a StorageClass](#create-a-storageclass)
    + [Create a PVC](#create-a-pvc)
    + [Clean-up](#cleanup)
- [9: ConfigMaps](#9-configmaps)
  * [How do ConfigMaps work](#how-do-configmaps-work)
  * [Hands-on with ConfigMaps](#handson-with-configmaps)
    + [Creating ConfigMaps imperatively](#creating-configmaps-imperatively)
    + [Inspecting ConfigMaps](#inspecting-configmaps)
    + [Creating ConfigMaps declaratively](#creating-configmaps-declaratively)
    + [ConfigMaps and environment variables](#configmaps-and-environment-variables)
    + [ConfigMaps and container startup commands](#configmaps-and-container-startup-commands)
    + [ConfigMaps and volumes](#configmaps-and-volumes)
