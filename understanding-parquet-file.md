...
I will not go into details how the performance improvements were achieved, but in summary[5]:
...
I'd like to just add on top what was outlined in the quote - remember Columnar layout optimizations, due to 
